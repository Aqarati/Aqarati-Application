...
import { View, TextInput, TouchableOpacity, Text, StyleSheet, ImageBackground, Image, Modal, Pressable } from 'react-native'; 
...
const allFieldsFilled = name.trim() && email.trim() && password.trim() && rePassword.trim(); // Include rePassword
...
const formIsValid = allFieldsFilled && Object.keys(errors).length === 0;
	return (
        <ImageBackground source={require('../../assets/images/img1.jpg')} style={styles.image}>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.inputContainer}>
                    ...
                    <TouchableOpacity onPress={() => setPasswordVisibility(!passwordVisibility)}>
                        <FontAwesome name={passwordVisibility ? 'eye-slash' : 'eye'} style={styles.icon} />
                    </TouchableOpacity>
                </View>
    ...
    <TouchableOpacity onPress={() => setConfirmPasswordVisibility(!confirmPasswordVisibility)}>
        <FontAwesome name={confirmPasswordVisibility ? 'eye-slash' : 'eye'} style={styles.icon} />
    </TouchableOpacity>
</View>
