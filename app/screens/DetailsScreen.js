    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.ratingContainer}>
        ...
        <Text style={styles.ratingText}>
          {itemDetails.stars} ({itemDetails.reviews} reviews)
        </Text>
      </View>
      <Text style={styles.sectionTitle}>Description</Text>
      <Text style={styles.description}>
        Experience unparalleled comfort and luxury at our stunning location in{" "}
        {itemDetails.name}. With top-of-the-line amenities and breathtaking
        views, your stay is guaranteed to be unforgettable.
      </Text>
